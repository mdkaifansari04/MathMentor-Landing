          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join MathMentor Today & Boost Your Math Skills
              </h2>
              <p>
                Unlock your full potential with MathMentor. Our AI-driven
                platform provides personalized math assistance and interactive
                tools to help you excel. Join us now and experience how easy and
                effective math learning can be.
              </p>
            </motion.div>
            <motion.div
              variants={{
