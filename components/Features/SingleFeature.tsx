...
const SingleFeature = ({ feature }: { feature: Feature }) => {
  const { icon, title, description, upcoming } = feature;
  ...
  return (
    <>
      ...
      >
        {upcoming && (
          <span className="absolute right-1 mb-4 mr-4 inline-flex rounded-full bg-meta px-4.5 py-1 text-metatitle uppercase text-white ">
            Upcoming
          </span>
        )}
