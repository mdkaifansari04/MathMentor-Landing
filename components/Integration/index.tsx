      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Seamlessly Connect and Manage Your Math Data Anytime, Anywhere`,
              description: `MathMentor offers robust integrations to keep your learning data synchronized and accessible across multiple platforms. Effortlessly track your progress and interact with our tools from any device, wherever you are.`,
            }}
          />
